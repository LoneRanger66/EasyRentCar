...
public class NetworkHelper {
    ...
    /**
     * 向要发送的JSON对象里面添加用户名和密码信息
     *
     * @param sndJsonObj 要发送的JSON对象
     * @param username   用户名
     * @param password   密码
     */
    public static void addUsernameAndPassword(JSONObject sndJsonObj, String username, String password) {
        try {
            sndJsonObj.put("username", username);
            sndJsonObj.put("password", password);
